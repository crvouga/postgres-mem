...
export const DDL_SECTION: CatalogSection = section("DDL", "Schema definition", true, [
  ...
  ["drop-03", "DROP TABLE CASCADE leaves dependent views behind", D, "oracle drops the dependent view; memory keeps a broken view (see tests/contract/_reports/catalog-querydml.md)"],
  ...
  ["comment-01", "COMMENT ON TABLE parses but is not stored", D, "oracle stores the comment; memory obj_description(oid) returns NULL (see tests/contract/_reports/catalog-querydml.md)"],
]);
